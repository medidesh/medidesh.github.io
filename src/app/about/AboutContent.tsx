...
const T = {
    bn: {
        ...
        heroSub: "গাজীপুর থেকে শুরু হওয়া এক স্বপ্ন—বাংলাদেশের প্রতিটি ফার্মেসিকে ডিজিটালাইজ করে মালিকদের জীবন সহজ ও স্বচ্ছ করা।",
    ...
    en: {
        ...
        heroSub: "Originating in Gazipur, our mission is to empower every pharmacy owner through smart digitization and simplified management.",
