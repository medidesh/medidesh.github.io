                ...
                <div className="container mx-auto px-6 lg:px-12 relative z-10">
                    <div className="max-w-2xl mx-auto text-center">
                        ...
                        <div className="space-y-4 text-slate-600 text-lg leading-relaxed text-left">
                            <p>
                                সংবাদপত্রের পাতায় প্রায়ই দেখা যায় মেয়াদোত্তীর্ণ ওষুধ বিক্রির দায়ে জরিমানা কিংবা ভুয়া ওষুধের ভিড়ে সাধারণ মানুষের দিশেহারা অবস্থা। Faysal খুব কাছ থেকে দেখেছিলেন এই সংকটের মূলে রয়েছে—অগোছালো ইনভেন্টরি। একজন সৎ ফার্মেসি মালিকও কেবল ম্যানুয়াল খাতার ভুলে মেয়াদোত্তীর্ণ ওষুধ বিক্রি করে ফেলছেন, যা হয়ে উঠছে মানুষের জীবনের ঝুঁকি।
                            </p>
                            <p>
                                এই তিক্ত অভিজ্ঞতাই রূপ নেয় মেডিদেশের আইডিয়ায়। ডিজিটাল ট্র্যাকিং ছাড়া এই সমস্যা সমাধান অসম্ভব—এটিই ছিল Faysal এবং Farhan-এর অভিন্ন উপলব্ধি। যেখানে বড় শহর ছাড়া আধুনিক প্রযুক্তির ছোঁয়া পৌঁছায়নি, সেখানে মেডিদেশ নিয়ে এসেছে এক সহজ সমাধান—যা কেবল স্টক ম্যানেজ করে না, বরং প্রতিটি পিলের সঠিক ট্র্যাকিং নিশ্চিত করে।
                            </p>
                            <p>
                                Noor-এর ফার্মাসিউটিক্যাল জ্ঞান এবং Jannatul-এর অপারেশনাল দক্ষতার সমন্বয়ে আমরা এমন এক প্ল্যাটফর্ম গড়েছি, যা সাধারণ ফার্মেসি মালিকদের শক্তিশালী করে। আমরা বিশ্বাস করি, ডিজিটাল রেকর্ডিং এবং অটোমেটেড এলার্টই পারে বাংলাদেশের প্রতিটি পরিবারের জন্য নিরাপদ ওষুধের নিশ্চয়তা দিতে।
                            </p>
                        </div>
                    </div>
                </div>
