...
export default function AboutPage() {
    return (
        <main className="bg-white min-h-screen">
            ...
            <section className="relative pt-28 pb-20 lg:pt-36 lg:pb-32 bg-white overflow-hidden">
                ...
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[700px] h-[400px] bg-medidesh-teal-500/5 rounded-full blur-[120px] pointer-events-none" />
                ...
                <div className="container mx-auto px-6 lg:px-12 relative z-10">
                    <div className="max-w-3xl mx-auto text-center">
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-slate-900 mb-8 leading-[1.1] tracking-tight">
            ...
            <section className="py-24 lg:py-32 bg-slate-50 border-y border-slate-100 relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 lg:px-12 relative z-10">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
                        {team.map((member, i) => (
                            <div
                                key={i}
                                className="relative overflow-hidden rounded-xl group cursor-default shadow-sm border border-slate-100"
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent group-hover:opacity-0 transition-opacity p-5 flex flex-col justify-end">
                    ...
                    <div className="max-w-5xl mx-auto mt-20 pt-16 border-t border-slate-100">
                        <div className="flex items-center gap-3 mb-10">
                            <div className="h-px flex-1 bg-slate-100" />
                            <span className="text-xs font-semibold uppercase text-slate-400 px-4 tracking-widest">বিশেষ সহযোগী</span>
                            <div className="h-px flex-1 bg-slate-100" />
                        </div>
                        <div className="grid grid-cols-2 lg:grid-cols-3 gap-6 max-w-3xl mx-auto">
                            {contributors.map((person, i) => (
                                <div
                                    key={i}
                                    className="relative overflow-hidden rounded-xl group cursor-default border border-slate-100 shadow-sm"
                                    style={{ aspectRatio: "3/4" }}
                                >
                                    <img
                                        src={person.photo}
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent p-5 flex flex-col justify-end">
                                        ...
                                        <p className="text-white/70 text-xs mt-1">{person.role}</p>
                                    </div>
                                    <div className="absolute bottom-0 left-0 right-0 h-1 bg-medidesh-teal-500 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left" />
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className="container mx-auto px-6 lg:px-12 relative z-10">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
                        {mentors.map((mentor, i) => (
                            <div
                                key={i}
                                className="relative overflow-hidden rounded-xl group cursor-default border border-slate-200 shadow-sm"
                                style={{ aspectRatio: "3/4" }}
                            >
                                <img
                                    src={mentor.photo}
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent p-5 flex flex-col justify-end">
                                    ...
                                    <span className="inline-block mt-1.5 px-2 py-0.5 bg-amber-400/20 border border-amber-300/40 text-amber-200 text-[10px] font-semibold rounded backdrop-blur-sm">
                                        {mentor.org}
                                    </span>
                                    <p className="text-white/60 text-xs mt-1.5">{mentor.role}</p>
                                </div>
            ...
            <section id="cta" className="py-24 lg:py-32 bg-medidesh-teal-500 relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 lg:px-12 relative z-10">
                    <div className="max-w-3xl mx-auto text-center">
                        <h2 className="text-3xl lg:text-5xl font-black text-white mb-8 leading-tight tracking-tight">
                            আজই শুরু করুন —<br />
                            <span className="text-medidesh-teal-100">বিনামূল্যে।</span>
                        </h2>
                        <p className="text-medidesh-teal-50 text-xl mb-12 max-w-xl mx-auto font-medium">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-5">
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-white hover:bg-slate-50 text-medidesh-teal-600 px-10 py-5 rounded-xl font-black text-base transition-all hover:-translate-y-1 shadow-2xl shadow-black/20"
                            >
                                <GooglePlayLogoIcon weight="fill" size={24} />
                                অ্যাপ ডাউনলোড করুন
                            </a>
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-medidesh-teal-600 text-white border-2 border-white/20 px-10 py-5 rounded-xl font-black text-base transition-all hover:bg-medidesh-teal-700 hover:-translate-y-1 shadow-lg"
                            >
                        ...
                        <p className="mt-10 text-medidesh-teal-100 text-sm font-bold">
