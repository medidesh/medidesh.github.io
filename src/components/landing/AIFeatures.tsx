            ...
            <div className="container mx-auto px-6 lg:px-12 relative z-10">
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
                    ...
                    <div className="lg:w-1/2">
                        ...
                        <p className="text-slate-400 text-lg lg:text-xl font-medium mb-8 max-w-xl leading-relaxed">
                            মেডিদেশ AI আপনার ফার্মেসির ডেটা বিশ্লেষণ করে সঠিক দিকনির্দেশনা দেবে।
                            আপনার ব্যবসা হবে আরও স্মার্ট ও গতিশীল।
                        </p>

                        <div className="flex flex-col gap-6">
                            {[
                                { title: "স্মার্ট সেলস ইনসাইটস", desc: "আপনার বিক্রয় ডেটা থেকে ভবিষ্যতের সঠিক পূর্বাভাস।", icon: <ChartLineUp /> },
                                { title: "অটোমেশন ম্যাজিক", desc: "স্টক ম্যানেজমেন্ট এবং অর্ডার রিপ্লেনিশমেন্ট এখন হবে সম্পূর্ণ স্বয়ংক্রিয়।", icon: <Lightning /> },
                                { title: "মেডিকেল নলেজ হাব", desc: "যেকোনো ওষুধের তথ্য এবং অল্টারনেটিভ ব্র্যান্ড সাজেশন।", icon: <Brain /> },
                            ].map((item, i) => (
