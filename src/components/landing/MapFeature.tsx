...
export default function MapFeature() {
    return (
        <section id="nearby" className="py-16 bg-white relative overflow-hidden">
            <div className="container mx-auto px-6 lg:px-12">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div className="order-1">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-blue-50 text-blue-600 text-xs font-bold mb-6 border border-blue-100">
                        ...
                        <p className="text-lg text-slate-500 mb-8 leading-relaxed">
                            ওষুধ খুঁজছেন? মেডিদেশ অ্যাপে সার্চ দিলেই ক্রেতা দেখতে পাবে আপনার
                            ফার্মেসিতে সেই ওষুধটি আছে কিনা এবং ম্যাপ দেখে চলে আসবে।
                        </p>
                        <ul className="space-y-4 mb-8">
                            <li className="flex items-start gap-3">
                                <CheckCircle weight="fill" className="text-blue-600 text-xl mt-1" />
                                <span className="text-slate-700 font-medium">
                                    আশেপাশের ক্রেতাদের কাছে দ্রুত পৌঁছান।
                                </span>
                            </li>
                            <li className="flex items-start gap-3">
                                <CheckCircle weight="fill" className="text-blue-600 text-xl mt-1" />
                                <span className="text-slate-700 font-medium">
                                    রিয়েল-টাইম স্টক আপডেট — ক্রেতা খালি হাতে ফিরবে না।
                                </span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="relative order-2 flex justify-center w-full">
                        <div className="relative w-full max-w-[300px] h-[500px] lg:h-[600px] bg-slate-900 rounded-[2rem] p-3 shadow-2xl border-4 border-slate-800 ring-1 ring-slate-900/50 mx-auto">
                            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-32 h-6 bg-slate-900 rounded-b-xl z-30"></div>

                            <div className="w-full h-full bg-slate-50 rounded overflow-hidden relative map-grid group">
                                {/* Search Bar */}
                                <div className="absolute top-10 left-3 right-3 bg-white p-2.5 rounded shadow-lg border border-slate-100 z-20 flex items-center gap-2">
                                ...
                                <div className="absolute bottom-16 left-1/2 transform -translate-x-1/2 z-10">
                                    <span className="relative flex h-20 w-20 items-center justify-center">
                                        ...
                                        <div className="w-8 h-8 bg-blue-600 rounded flex items-center justify-center text-white ring-4 ring-white shadow-xl">
                                ...
                                {/* Pharmacy Pin 1 */}
                                <div className="absolute top-28 left-4 bg-white p-2 rounded shadow-xl border border-pharma-green-100 z-10 max-w-[140px] animate-[bounce_2s_infinite]">
