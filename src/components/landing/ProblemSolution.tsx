...
const PHARMA_COMPANIES = [
    { name: "SQUARE", color: "bg-blue-500", style: "border-slate-900 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] rounded-full" },
    { name: "BEXIMCO", color: "bg-red-500", style: "border-slate-900 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] rounded-full" },
    { name: "INCEPTA", color: "bg-green-500", style: "border-slate-900 shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] rounded-xl" },
    { name: "ACME", color: "bg-purple-500", style: "border-slate-900 shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] rounded-full" },
    { name: "RENATA", color: "bg-orange-500", style: "border-medidesh-teal-600 shadow-[4px_4px_0px_0px_rgba(13,148,136,1)] rounded-lg text-medidesh-teal-700" },
    { name: "OPSONIN", color: "bg-pink-500", style: "border-slate-900 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] rounded-full" },
    { name: "ESKAYEF", color: "bg-teal-500", style: "border-slate-900 shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] rounded-full" },
    { name: "ARISTOPHARMA", color: "bg-indigo-500", style: "border-slate-900 shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] rounded-xl" },
    { name: "DRUG INT.", color: "bg-yellow-500", style: "border-slate-900 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] rounded-full" },
    { name: "HEALTHCARE", color: "bg-cyan-500", style: "border-slate-900 shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] rounded-full" },
    { name: "RADIANT", color: "bg-rose-500", style: "border-slate-900 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] rounded-lg" },
    { name: "POPULAR", color: "bg-emerald-500", style: "border-slate-900 shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] rounded-full" },
    { name: "ACI", color: "bg-sky-500", style: "border-slate-900 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] rounded-full" },
    { name: "ORION", color: "bg-fuchsia-500", style: "border-medidesh-teal-600 shadow-[3px_3px_0px_0px_rgba(13,148,136,1)] rounded-xl text-medidesh-teal-700" },
    { name: "NAVANA", color: "bg-lime-500", style: "border-slate-900 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] rounded-full" },
    { name: "GENERAL", color: "bg-amber-500", style: "border-slate-900 shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] rounded-full" },
    { name: "BEACON", color: "bg-violet-500", style: "border-slate-900 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] rounded-lg" },
    { name: "JMI", color: "bg-red-600", style: "border-slate-900 shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] rounded-full" },
    { name: "LABAID", color: "bg-green-600", style: "border-slate-900 shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] rounded-full" },
    { name: "DELTA", color: "bg-blue-600", style: "border-slate-900 shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] rounded-xl" },
];
