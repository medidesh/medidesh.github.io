                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 border-b border-slate-900 pb-16">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            ...
                            <a href="https://play.google.com/store/apps/details?id=com.medidesh.pharmacy" target="_blank" className="flex items-center gap-2.5 bg-slate-900/50 border border-slate-800 rounded-xl py-2.5 px-4 hover:bg-slate-800 transition-all group">
                            ...
                            <button onClick={handleAppStoreClick} className="flex items-center gap-2.5 bg-slate-900/50 border border-slate-800 rounded-xl py-2.5 px-4 hover:bg-slate-800 transition-all group cursor-pointer text-left">
                                <div className="group-hover:scale-110 transition-transform">
                                    <svg viewBox="0 0 24 24" className="w-5 h-5 fill-white">
