        ...
        <footer className="bg-slate-950 pt-20 pb-10 relative overflow-hidden border-t border-slate-900">
            ...
            <div className="container mx-auto px-4 lg:px-8 relative z-10">
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 border-b border-slate-900 pb-16">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="flex items-center gap-4">
                            {pharmacy.social?.facebook && (
                                <a href={pharmacy.social.facebook} target="_blank" className="w-10 h-10 rounded-xl bg-slate-900 flex items-center justify-center text-slate-400 hover:text-blue-500 hover:bg-slate-800 transition-all border border-slate-800">
                    ...
                    <div className="lg:col-span-2">
                        <h4 className="text-slate-400 font-black mb-6 text-xs uppercase tracking-[0.2em]">Download Now</h4>
                        <div className="flex flex-col sm:flex-row gap-3">
                            {/* Google Play Button - Compact */}
                            <a href="#" className="flex items-center gap-2.5 bg-slate-900/50 border border-slate-800 rounded-xl py-2.5 px-4 hover:bg-slate-800 transition-all group">
